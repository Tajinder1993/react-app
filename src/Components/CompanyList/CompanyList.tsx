                    ...
                    <div className="card-body">
                      ...
                      <label className="form-check">
                        <input
                          ...
                          value=""
                        />
                        <span className="form-check-label">Top-Level (40)</span>
                      </label>
                      <label className="form-check">
                        <input
                          className="form-check-input"
                          ...
                          value=""
                        />
                        <span className="form-check-label">Mid-Level (50)</span>
                      </label>
                    </div>
                    {/* card-body.//  */}
                  </div>
                      ...
                      <form>
                        <label className="form-check">
                          <input
                            ...
                            value=""
                          />
                          <span className="form-check-label">Today (100)</span>
                        </label>
                        {/* form-check.//  */}
                        <label className="form-check">
                          <input
            ...
            <div className="col-sm-9">
              <div className="row clist">
                <div
                  ...
                  data-wow-delay="0.1s"
                >
                  <Link className="cat-item rounded p-4" to={"/CompanyDetail"}>
